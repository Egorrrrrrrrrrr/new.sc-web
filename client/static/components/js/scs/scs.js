            ...
            if (treeNode.attrs.length > 0 && !treeNode.mergePrev) {
                ...
                for (idx in treeNode.attrs) {
                    ...
                    <div class="box-header with-border" style="padding: 5px;">\
                        <h3 class="box-title">\
                        <a href="#" class="scs-scn-element scs-scn-highlighted resolve-idtf-anim" sc_addr="' + attr.n.addr + '"></a>\
                        </h3>\
        ...
        window.scHelper.getLanguages().done(function(langs){
            ...
            //for (var i in langs){
              //  var lang = langs[i];
                ...
                // it contains both a file frame and a language noded
                
                $("a[sc_addr='758644736']").parent().parent().remove();
                $("a[sc_addr='769130496']").parent().parent().remove();
                $("div[sc_addr='762839040']").remove();
                $("div[sc_addr='2356674560']").remove();
                $("a[sc_addr='4849664']").parent().parent().remove();

                
                
                

                $("a[sc_addr='196608']").parent().parent().parent().addClass('box-danger box-primary');
                 $("a[sc_addr='8650752']").parent().parent().parent().addClass('box-success');
                  $("a[sc_addr='966262784']").parent().parent().parent().addClass('box-warning');
                   $("a[sc_addr='970457088']").parent().parent().parent().addClass('box-info');
                   
                   

                var title = $("div#section-window-container").children().children().children().children().children().find(".scs-scn-keyword");
                var content = $("div#section-window-container").find(".panel-default").css({"border":"0px", "background-color":"rgba(255, 255, 255, 0)"});
                $("div#section-window-container").find(".panel-body").css({"padding":"rgba(255, 255, 255, 0)", "height":"600px"});
                $("div#section-window-container").find(".box").css({"background":"10px", "border-top":"0px", "box-shadow":"0 0 0", "margin":"0px"});
                $("div#section-window-container").find(".box-tools").remove();
                
                $("div#section-window-container div.panel-body div.box-body").find(".box-header").remove();

                $("div#section-window-container").find(".scs-scn-field-marker").remove();

                $("div.ui-no-tooltip").find(".box").css({"height":"660px"});

                //$("div.scs-scn-field").css({"width":"660px"});
                //.wrap("<div class='new'></div>"); box-title main-title
                //var title = $("div#section-window-container").children().children().children().children().find(".scs-scn-keyword");             
               /* if (($('.nav1').html()) == '')
                {
                    //$("div#section-window-container div.panel-body div.box-body div.scs-scn-field").find(".scs-scn-element").wrap('<li><a href="#"></a></li>');
                $("div#section-window-container div.panel-body div.box-body").find("div.scs-scn-field").wrap('<li><a href="#"></ a></li>');
                $("div#section-window-container div.panel-body div.box-body").wrap('<ul class="treeview-menu"></ull>');

                $("div#section-window-container div.panel-body").wrap('<ul class="treeview-menu"></ul>').prepend("<a href='#'><i class='fa fa-dashboard'></i> <span class='glav-1'>"+ title.text() + "</span><i class='fa fa-angle-left pull-right'></i></a>").wrap('<li class="treeview"></li>');
                //$("div#section-window-container div.panel-body h3.box-title").wrap('<a href="#"></a>');
                //$("div#section-window-container").wrap('<li class="treeview"></li>');

               //$("div#section-window-container").find(".box").wrap('<ul class="treeview-menu"></ull>');
                //$("div#section-window-container").wrap('<li class="treeview"><a href="#"><span></span></a></li>');
                //$("ul#history-items").wrap('<li class="treeview"><a href="#"></a></li>');
                

                

                    add = $('.nav1').append('<a href="#">\
                        <i class="fa fa-dashboard"></i> <span class="glav-1">'+ title.text() +'</span><i class="fa fa-angle-left pull-right"></i>\
                      </a>\
                      <ul class="treeview-menu ul1">\
                      </ul>');

                    add = $('.ul1').append('<li>'+ content.html() +'</li>');

                }*/

                
                //$("a[sc_addr='8650752']").parent().parent().remove();

                //$("a[sc_addr='196608']").parent().parent().remove();

                //$("a[sc_addr='769130496']").parent().parent().remove();
                //var title = $(".scs-scn-keyword").remove();
                //$('span.glav-1').html(title);
